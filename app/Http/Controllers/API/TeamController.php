...
class TeamController extends Controller
{
    public function fetch(Request $request) //fech untuk mengambil data satuan
    {
        ...
        return ResponseFormatter::success(
            $teams->paginate($limit), //fungsi ini dapat menggunakan fiturnya laravel
            'Teams found'
        );
    }
    ...
    public function destroy($id) //ini untuk menghapus
    {
        try {
            // Get team
            $team = Team::find($id);
            ...
            // Delete team (inisudah pakai soft delete)
            $team->delete();
