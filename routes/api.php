...
//Violation API
Route::prefix('violation')->middleware('auth:sanctum')->name('violation.')->group(function () {
    Route::get('', [ViolationController::class, 'fetch'])->name('fetch');
    Route::post('', [ViolationController::class, 'create'])->name('create');
    Route::post('update/{id}', [ViolationController::class, 'update'])->name('update');
    Route::delete('{id}', [ViolationController::class, 'destroy'])->name('delete');
});
